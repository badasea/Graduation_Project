...
export default function PersistentDrawerLeft() {
  ...
  const edit = (item, e) => {
    ...
    window.sessionStorage.setItem("admin_order", JSON.stringify(session_edit));
    document.location.href = "/admin/order/edit";
  };
            ...
            <TableBody>
              {searchResults.slice(offset, offset + limit).map((items) => (
                ...
                >
                  ...
                  <TableCell align="right">
                    <p>{items.order_state}</p>
                  </TableCell>
                  <TableCell align="right">
                    <p>{items.order_shop_name}</p>
                  </TableCell>
                  <TableCell align="right">
                  ...
                  <TableCell align="right">
                    <p>{items.order_user_id}</p>
                  </TableCell>
                  <TableCell align="right">
                    <p>{items.order_shop_id}</p>
                  </TableCell>
                  <TableCell align="right">
                    <Button
                      sx={{
