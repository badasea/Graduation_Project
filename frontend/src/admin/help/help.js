...
export default function PersistentDrawerLeft() {
  ...
  const item_remove = (id) => {
    ...
    axios
      .delete(process.env.REACT_APP_API_URL + "/api/help/" + id, {})
      .then((res) => {
  ...
  const edit = (item, e) => {
    ...
    window.sessionStorage.setItem("admin_help", JSON.stringify(session_edit));
    document.location.href = "/admin/help/edit";
  };
