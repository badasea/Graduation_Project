...
### 현재 개발 스터디 및 설계 고려가 필요한 부분(22년 3월 19일 기준)
...
2. 장바구니 결재, 고객센터(게시물 등록, 문의 이미지 등록 기능), 수주매출 기능, chart.js 그래프 고려

3. admin system(관리자 시스템) 데이터 수정, 대시보드 미구현

4. 데이터 잇슈 (공공데이터 활용 or 가상 데이터 생성)
...
# ⚙ 시스템 아키텍처 (~ing 2022. 03. 07)

![image](https://user-images.githubusercontent.com/57929751/156972967-dcf712cf-dcfe-4012-aaf9-54258d54c491.png)
...
![image](https://user-images.githubusercontent.com/57929751/158049951-42ad15be-2884-40ec-af40-3092d0221395.png)
